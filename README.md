...
|-------------|------|-------|--------|--------------|
| setOptions | setOptions |  | `trackingStyle: {<br/>height:4,backgroundColor: "rgba(204, 204, 204, 0.3)",<br/>...}`,\\`indicatorStyle:{\backgroundColor: "#F01D7C",\...}` | if you want to change indicator height, that in like this `trackingStyle: {height:5}`, the same goes for `borderRadius` |
